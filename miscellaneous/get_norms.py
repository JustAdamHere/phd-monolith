def get_norms(program, geometry, run_no):
  ...
  time_step = flux_data.get('timestep_no').to_numpy()
  ...
  return np.array([dofs, L2_u, L2_p, L2_up, E_up, div_u]), np.array([L2_u_ratio, L2_p_ratio, L2_up_ratio, E_up_ratio, div_u_ratio])