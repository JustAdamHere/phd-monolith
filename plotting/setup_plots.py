...
def get_data(no_bins, simulation_bins, simulations):
  ...
  data = [transport_reaction_integrals, velocity_magnitude_integrals, slow_velocity_percentages_ivs, slow_velocity_percentages_everywhere, slow_velocity_percentage_dellschaft, fast_velocity_percentage_dellschaft]
  averages = [average_transport_reaction_integral, average_velocity_magnitude_integral, average_slow_velocity_percentage_ivs, average_slow_velocity_percentage_everywhere, average_slow_velocity_percentage_dellschaft, average_fast_velocity_percentage_dellschaft]

  return data[0], data[1], data[2], data[3], data[4], data[5], averages[0], averages[1], averages[2], averages[3], averages[4], averages[5]