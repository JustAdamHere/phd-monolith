def plot(simulations, simulation_bins, parameter_values, parameter_name, parameter_safe_name, subfolder=None):
  ...
  ax_transport_percentage_combined.fill_between(parameter_values, data['q25']['transport_percentage_basal_plate'], data['q75']['transport_percentage_basal_plate'], alpha=0.2, color="C0")
  ax_transport_percentage_combined.plot(parameter_values, data['q25']['transport_percentage_basal_plate'], linestyle="dashed", linewidth=1, color="C0")
  ax_transport_percentage_combined.plot(parameter_values, data['q75']['transport_percentage_basal_plate'], linestyle="dashed", linewidth=1, color="C0")
  ...
  setup_plots.style(fig_velocity_percentage_basal_plate             , ax_velocity_percentage_basal_plate             , parameter_name, r"XXX"                                                                , y_scilimits=None , y_top=100 )
  setup_plots.style(fig_velocity_percentage_septal_wall             , ax_velocity_percentage_septal_wall             , parameter_name, r"XXX"                                                                , y_scilimits=None , y_top=100 )
  setup_plots.style(fig_velocity_percentage_marginal_sinus          , ax_velocity_percentage_marginal_sinus          , parameter_name, r"XXX"                                                                , y_scilimits=None , y_top=100 )
  setup_plots.style(fig_transport_percentage_basal_plate            , ax_transport_percentage_basal_plate            , parameter_name, r"XXX"                                                                , y_scilimits=None , y_top=100 )
  setup_plots.style(fig_transport_percentage_septal_wall            , ax_transport_percentage_septal_wall            , parameter_name, r"XXX"                                                                , y_scilimits=None , y_top=100 )
  setup_plots.style(fig_transport_percentage_marginal_sinus         , ax_transport_percentage_marginal_sinus         , parameter_name, r"XXX"                                                                , y_scilimits=None , y_top=100 )
  setup_plots.style(fig_velocity_percentage_combined                , ax_velocity_percentage_combined                , parameter_name, r"XXX"                                                                , y_scilimits=None , y_top=100 )
  setup_plots.style(fig_transport_percentage_combined               , ax_transport_percentage_combined               , parameter_name, r"XXX"                                                                , y_scilimits=None , y_top=100 )
