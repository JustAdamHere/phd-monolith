def plot_others(simulations, simulation_bins, parameter_values, parameter_name, parameter_safe_name, subfolder=None):
  ...
  setup_plots.style(fig, axes[6][0], None, r"$E_\text{kinetic}(\Gamma_\text{in}) - E_\text{kinetic}(\Gamma_\text{out})$", y_scilimits=[1, 1], y_bottom=0, y_top=6e1, integer_ticks=False, max_major_ticks=3)
  setup_plots.style(fig, axes[7][0], parameter_name[0], r"$E_\text{total}(\Gamma_\text{in}) - E_\text{total}(\Gamma_\text{out})$", y_scilimits=[2, 2], y_bottom=0, y_top=1e3, integer_ticks=False, max_major_ticks=3, y_labelpad=25)
...
def plot_vessels(simulations, simulation_bins, parameter_values, parameter_name, parameter_safe_name, subfolder=None):
  ...
  setup_plots.style(fig, axes[6][0], None, r"$E_\text{kinetic}(\Gamma_\text{in}) - E_\text{kinetic}(\Gamma_\text{out})$", y_scilimits=[1, 1], y_bottom=0, y_top=6e1, integer_ticks=True)
  setup_plots.style(fig, axes[7][0], parameter_name[0], r"$E_\text{total}(\Gamma_\text{in}) - E_\text{total}(\Gamma_\text{out})$", y_scilimits=[2, 2], y_bottom=0, y_top=1e3, integer_ticks=True, y_labelpad=25)
  ...
  setup_plots.style(fig, axes[6][1], None, None, y_scilimits=[1, 1], y_bottom=0, y_top=6e1, integer_ticks=True, max_major_ticks=4)
  setup_plots.style(fig, axes[7][1], parameter_name[1], None, y_scilimits=[2, 2], y_bottom=0, y_top=1e3, integer_ticks=True, max_major_ticks=4)
  ...
  setup_plots.style(fig, axes[6][2], None, None, y_scilimits=[1, 1], y_bottom=0, y_top=6e1, integer_ticks=True, max_major_ticks=4)
  setup_plots.style(fig, axes[7][2], parameter_name[2], None, y_scilimits=[2, 2], y_bottom=0, y_top=1e3, integer_ticks=True, max_major_ticks=4)
