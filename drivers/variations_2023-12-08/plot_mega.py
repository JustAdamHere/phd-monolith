def plot_others(simulations, simulation_bins, parameter_values, parameter_name, parameter_safe_name, subfolder=None):
  ...
  fig, axes = setup_plots.setup_megaplot(1, 8, 3, figsize=(12, 18))
  ...
  setup_plots.style(fig, axes[4][0], None, r"$\bar{c}$", y_scilimits=[-3, -3], y_bottom=0, y_top=2e-3, integer_ticks=False, max_major_ticks=3, max_minor_ticks=10)
  setup_plots.style(fig, axes[5][0], None, r"$c_\text{flux}(\Gamma_\text{in}) - c_\text{flux}(\Gamma_\text{out})$", y_scilimits=None , y_top=102, integer_ticks=False, max_major_ticks=3, max_minor_ticks=10, y_labelpad=15)
  ...
  setup_plots.style(fig, axes[4][2], None, None, y_scilimits=[-3, -3], y_bottom=0, y_top=2e-3, integer_ticks=False, max_major_ticks=3, max_minor_ticks=10)
  setup_plots.style(fig, axes[5][2], None, None, y_scilimits=None , y_top=102, integer_ticks=False, max_major_ticks=3, max_minor_ticks=10)
  setup_plots.style(fig, axes[6][2], None, None, y_scilimits=[-3, -3], y_bottom=0, y_top=2e-3, integer_ticks=False, max_major_ticks=3, max_minor_ticks=10)
  setup_plots.style(fig, axes[7][2], parameter_name[2], None, y_scilimits=[4, 4], y_bottom=0, y_top=5e5, integer_ticks=False, max_major_ticks=3, max_minor_ticks=10)
...
def plot_vessels(simulations, simulation_bins, parameter_values, parameter_name, parameter_safe_name, subfolder=None):
  ...
  # Setup plots.
  from plotting import setup_plots
  fig, axes = setup_plots.setup_megaplot(1, 8, 3, figsize=(8, 18))
  ...
  setup_plots.style(fig, axes[0][2], None, None, y_scilimits=[-3, -3], y_bottom=0, y_top=1e-2, integer_ticks=True)
  setup_plots.style(fig, axes[1][2], None, None, y_scilimits=None , y_top=102, integer_ticks=True)
  setup_plots.style(fig, axes[2][2], None, None, y_scilimits=None , y_top=102, integer_ticks=True)
  setup_plots.style(fig, axes[3][2], None, None, y_scilimits=[-3, -3], y_bottom=0, y_top=2e-2, integer_ticks=True)
  setup_plots.style(fig, axes[4][2], None, None, y_scilimits=[-3, -3], y_bottom=0, y_top=2e-3, integer_ticks=True)
  setup_plots.style(fig, axes[5][2], None, None, y_scilimits=None , y_top=102, integer_ticks=True)
  setup_plots.style(fig, axes[6][2], None, None, y_scilimits=[-3, -3], y_bottom=0, y_top=2e-3, integer_ticks=True)
  setup_plots.style(fig, axes[7][2], parameter_name[2], None, y_scilimits=[4, 4], y_bottom=0, y_top=1e5, integer_ticks=True)
