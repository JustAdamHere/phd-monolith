def plot_others(simulations, simulation_bins, parameter_values, parameter_name, parameter_safe_name, subfolder=None):
  ...
  setup_plots.style(fig, axes[6][1], None, None, y_scilimits=None, y_bottom=0.8, y_top=1.02, integer_ticks=True, max_major_ticks=5)
  setup_plots.style(fig, axes[7][1], parameter_name[1], None, y_scilimits=None, y_bottom=0.8, y_top=1.02, integer_ticks=True, max_major_ticks=5)
  ...
  setup_plots.style(fig, axes[6][2], None, None, y_scilimits=None, y_bottom=0.8, y_top=1.02, integer_ticks=False, max_major_ticks=3)
  setup_plots.style(fig, axes[7][2], parameter_name[2], None, y_scilimits=None, y_bottom=0.8, y_top=1.02, integer_ticks=False, max_major_ticks=3)
