...
def run_single(sim_no, parameters):
  from programs import velocity_transport
  ...
  no_marginal_sinus_veins = choose_vessels.calculate_no_ms      ()
  no_arteries             = choose_vessels.calculate_no_arteries(parameters["no_placentones"])

  # Select which of these vessels are turned on.
  parameters["basal_plate_vessels"], parameters["marginal_sinus_veins"], parameters["septal_wall_veins"] = choose_vessels.calculate_vessel_enabled(no_veins, no_arteries, no_marginal_sinus_veins, parameters["no_placentones"])
