...
# Varying parameters.
parameter_name      = [r"$2r_a$ (mm)", r"$2r_v$ (mm)", r"$h/h_0$", r"$D$ ($\times 10^{-9}$) (mm$^2$/s)", r"$R$ ($\times 10^{-2}$) (1/s)", r"$k$ ($\log_{10}$) (mm$^2$)"]
parameter_safe_name = ["artery_width", "vein_width", "wall_height_ratio", "oxygen_diffusivity", "oxygen_uptake", "permeability"]
...
parameter_values = [artery_width_values, vein_width_values, wall_height_values, oxygen_diffusivity_values, oxygen_uptake_values, permeability_values]
...
# Plot the data.
import plot_mega
bins = [bins_artery_width, bins_vein_width, bins_wall_height, bins_oxygen_diffusivity, bins_oxygen_uptake, bins_permeability]
