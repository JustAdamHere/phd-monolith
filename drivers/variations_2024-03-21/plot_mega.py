...
def plot_vessels(simulations, simulation_bins, parameter_values, parameter_name, parameter_safe_name, subfolder=None, plot_outliers=False):
  ...
  axes[4][0].legend(handles=handles[0:2], labels=["any veins", "27 veins"], loc="lower right")
  axes[4][1].legend(handles=handles[0:2], labels=["any arteries", "6 arteries"], loc="lower left")
  ...
  axes[6][0].legend(handles=handles[0:2], labels=["any veins", "27 veins"], loc="lower right")
  axes[6][1].legend(handles=handles[0:2], labels=["any arteries", "6 arteries"], loc="lower right")
  ...
  axes[7][0].legend(handles=handles[0:2], labels=["any veins", "27 veins"], loc="lower right")
  axes[7][1].legend(handles=handles[0:2], labels=["any arteries", "6 arteries"], loc="lower right")
