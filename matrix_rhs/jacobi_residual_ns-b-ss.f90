module jacobi_residual_ns_b_ss
  use bcs_velocity
  ...
  !!   26-10-2022
  !-------------------------------------------------------------------- 
  subroutine element_residual_ns_b_ss(element_rhs, &
  ...
  end subroutine element_residual_ns_b_ss
  ...
  !!   26-10-2022
  !  --------------------------------------------------------------
  subroutine element_residual_face_ns_b_ss(face_residual_p,face_residual_m, &
    mesh_data,soln_data,facet_data,fe_basis_info)
    !--------------------------------------------------------------------            
    use problem_options
    use problem_options_velocity
    ...
    associate( &
      ...
      !   print *, "Regions should be 3XX or 5XX (not 4XX)."
      ...
      ! If we're on a Brinkman boundary.
        ...
        print *, bdry_face
        print *, face_element_region_ids(1)
        print *, face_element_region_ids(2)
        stop
      end if
  ...
  end subroutine element_residual_face_ns_b_ss
  !--------------------------------------------------------------------
  ! PURPOSE:
  ...
  !!   26-10-2022
  !--------------------------------------------------------------------
  subroutine jacobian_ns_b_ss(element_matrix, &
    mesh_data, soln_data, facet_data, fe_basis_info)
    !--------------------------------------------------------------------
    use problem_options
    use problem_options_velocity
  ...
  end subroutine jacobian_ns_b_ss
  ...
  !!   26-10-2022
  !--------------------------------------------------------------------
  subroutine jacobian_face_ns_b_ss(face_matrix_pp,face_matrix_pm, &
  ...
  end subroutine jacobian_face_ns_b_ss
