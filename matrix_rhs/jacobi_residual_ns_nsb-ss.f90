module jacobi_residual_ns_nsb_ss
  use bcs_velocity
  ...
  !!   26-10-2022
  !--------------------------------------------------------------------
  subroutine element_residual_ns_nsb_ss(element_rhs, &
  ...
  end subroutine element_residual_ns_nsb_ss
  ...
  !!   26-10-2022
  !  --------------------------------------------------------------
  subroutine element_residual_face_ns_nsb_ss(face_residual_p,face_residual_m, &
    mesh_data,soln_data,facet_data,fe_basis_info)
    !--------------------------------------------------------------------
    use problem_options
    use problem_options_velocity
  ...
  end subroutine element_residual_face_ns_nsb_ss
  !--------------------------------------------------------------------
  ! PURPOSE:
  ...
  !!   26-10-2022
  !--------------------------------------------------------------------
  subroutine jacobian_ns_nsb_ss(element_matrix, &
    mesh_data, soln_data, facet_data, fe_basis_info)
    !--------------------------------------------------------------------
    use problem_options_velocity
  ...
  end subroutine jacobian_ns_nsb_ss
  ...
  !!   26-10-2022
  !--------------------------------------------------------------------
  subroutine jacobian_face_ns_nsb_ss(face_matrix_pp,face_matrix_pm, &
  ...
  end subroutine jacobian_face_ns_nsb_ss
  ...
  !!   22-06-2023
  !--------------------------------------------------------------------
  subroutine element_residual_cg_boundary_ns_nsb_ss(face_residual, mesh_data, soln_data, facet_data, fe_basis_info)
    use param
