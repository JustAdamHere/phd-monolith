...
If (!Exists(central_cavity_width))
	central_cavity_width = 5*pipe_width; // 10 mm
EndIf
...
If (!Exists(central_cavity_transition))
	central_cavity_transition = 0.02; // 10.8 mm
EndIf
...
For k In {0:5:1}
	...
	cavity_x_1[k] = centre_x + radius*Cos(theta_pipe[k*3+1] + (central_cavity_width/2 + central_cavity_transition/2)/radius);
	cavity_y_1[k] = centre_y - radius*Sin(theta_pipe[k*3+1] + (central_cavity_width/2 + central_cavity_transition/2)/radius);

	cavity_x_3[k] = centre_x + radius*Cos(theta_pipe[k*3+1] - (central_cavity_width/2 + central_cavity_transition/2)/radius);
	cavity_y_3[k] = centre_y - radius*Sin(theta_pipe[k*3+1] - (central_cavity_width/2 + central_cavity_transition/2)/radius);
EndFor
...
k = 0;
If (k == 0)
  Circle(numbering_start + k*placentone_step + 1)   = {1001, 1000, numbering_start + k*placentone_step + 19};
EndIf
...
Circle(numbering_start + k*placentone_step + 23)  = {numbering_start + k*    placentone_step + 19, 1000, numbering_start + k*placentone_step + 5};
Circle(numbering_start + k*placentone_step + 26)  = {numbering_start + k*    placentone_step + 8,  1000, numbering_start + k*placentone_step + 21};
Circle(numbering_start + k*placentone_step + 9)   = {numbering_start + k*    placentone_step + 21, 1000, numbering_start + k*placentone_step + 13};
If (k == 5)
  Circle(numbering_start + k*placentone_step + 13)  = {numbering_start + k*    placentone_step + 12, 1000, 1002};
EndIf
...
k = 3;
If (k != 0)
  Circle(numbering_start + k*placentone_step + 1)   = {numbering_start + (k-1)*placentone_step + 17, 1000, numbering_start + k*placentone_step + 19};
EndIf
Circle(numbering_start + k*placentone_step + 23)  = {numbering_start + k*    placentone_step + 19, 1000, numbering_start + k*placentone_step + 5};
Circle(numbering_start + k*placentone_step + 26)  = {numbering_start + k*    placentone_step + 8,  1000, numbering_start + k*placentone_step + 21};
Circle(numbering_start + k*placentone_step + 9)   = {numbering_start + k*    placentone_step + 21, 1000, numbering_start + k*placentone_step + 9};
...
// Pipe sides.
Physical Curve("boundary", 100) += {                                                                                  numbering_start + 0*placentone_step + 6, numbering_start + 0*placentone_step + 8, numbering_start + 0*placentone_step + 10, numbering_start + 0*placentone_step + 12};
Physical Curve("boundary", 100) += {numbering_start + 1*placentone_step + 2, numbering_start + 1*placentone_step + 4, numbering_start + 1*placentone_step + 6, numbering_start + 1*placentone_step + 8                                                                                    };
Physical Curve("boundary", 100) += {numbering_start + 2*placentone_step + 2, numbering_start + 2*placentone_step + 4, numbering_start + 2*placentone_step + 6, numbering_start + 2*placentone_step + 8                                                                                    };
Physical Curve("boundary", 100) += {                                                                                  numbering_start + 3*placentone_step + 6, numbering_start + 3*placentone_step + 8, numbering_start + 3*placentone_step + 10, numbering_start + 3*placentone_step + 12};
Physical Curve("boundary", 100) += {numbering_start + 4*placentone_step + 2, numbering_start + 4*placentone_step + 4, numbering_start + 4*placentone_step + 6, numbering_start + 4*placentone_step + 8                                                                                    };
Physical Curve("boundary", 100) += {                                                                                  numbering_start + 5*placentone_step + 6, numbering_start + 5*placentone_step + 8, numbering_start + 5*placentone_step + 10, numbering_start + 5*placentone_step + 12};
...
// Curved boundary.
Physical Curve("boundary-curve", 101)  = {numbering_start + 0*placentone_step + 1,                                          numbering_start + 0*placentone_step + 23, numbering_start + 0*placentone_step + 26, numbering_start + 0*placentone_step + 9, numbering_start + 0*placentone_step + 13};
Physical Curve("boundary-curve", 101) += {numbering_start + 1*placentone_step + 1, numbering_start + 1*placentone_step + 5, numbering_start + 1*placentone_step + 23, numbering_start + 1*placentone_step + 26, numbering_start + 1*placentone_step + 9                                          };
Physical Curve("boundary-curve", 101) += {numbering_start + 2*placentone_step + 1, numbering_start + 2*placentone_step + 5, numbering_start + 2*placentone_step + 23, numbering_start + 2*placentone_step + 26, numbering_start + 2*placentone_step + 9                                          };
Physical Curve("boundary-curve", 101) += {numbering_start + 3*placentone_step + 1,                                          numbering_start + 3*placentone_step + 23, numbering_start + 3*placentone_step + 26, numbering_start + 3*placentone_step + 9, numbering_start + 3*placentone_step + 13};
Physical Curve("boundary-curve", 101) += {numbering_start + 4*placentone_step + 1, numbering_start + 4*placentone_step + 5, numbering_start + 4*placentone_step + 23, numbering_start + 4*placentone_step + 26, numbering_start + 4*placentone_step + 9                                          };
Physical Curve("boundary-curve", 101) += {numbering_start + 5*placentone_step + 1,                                          numbering_start + 5*placentone_step + 23, numbering_start + 5*placentone_step + 26, numbering_start + 5*placentone_step + 9, numbering_start + 5*placentone_step + 13};

// Added extras.
//Physical Curve("boundary", 100) += {numbering_start + 1*placentone_step + 20, numbering_start + 2*placentone_step + 20, numbering_start + 3*placentone_step + 18, numbering_start + 4*placentone_step + 20, numbering_start + 5*placentone_step + 18};
...
// Placentones.
offset = numbering_start + 0*placentone_step;
Curve Loop(1) = {offset + 1, offset + 21, offset + 22, offset + 9, offset + 20, offset + 13, offset + 14, offset + 15, 201, 306, 1010};

offset_prev = numbering_start + 0*placentone_step;
offset      = numbering_start + 1*placentone_step;
Curve Loop(2) = {offset + 1, offset + 18, offset + 5, offset + 21, offset + 22, offset + 9, offset + 14, offset + 15, 202, 305, -201, offset_prev + 16, offset_prev + 17};

offset_prev = numbering_start + 1*placentone_step;
offset      = numbering_start + 2*placentone_step;
Curve Loop(3) = {offset + 1, offset + 18, offset + 5, offset + 21, offset + 22, offset + 9, offset + 14, offset + 15, 203, 304, -202, offset_prev + 16, offset_prev + 17};

offset_prev = numbering_start + 2*placentone_step;
offset      = numbering_start + 3*placentone_step;
Curve Loop(4) = {offset + 1, offset + 21, offset + 22, offset + 9, offset + 20, offset + 13, offset + 14, offset + 15, 204, 303, -203, offset_prev + 16, offset_prev + 17};

offset_prev = numbering_start + 3*placentone_step;
offset      = numbering_start + 4*placentone_step;
Curve Loop(5) = {offset + 1, offset + 18, offset + 5, offset + 21, offset + 22, offset + 9, offset + 14, offset + 15, 205, 302, -204, offset_prev + 16, offset_prev + 17};

offset_prev = numbering_start + 4*placentone_step;
offset      = numbering_start + 5*placentone_step;
Curve Loop(6) = {offset + 1, offset + 21, offset + 22, offset + 9, offset + 20, offset + 13, 1006, 301, -205, offset_prev + 16, offset_prev + 17};
